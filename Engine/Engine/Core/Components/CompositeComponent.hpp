...
namespace Engine
{
     ...
     * TCompositeBaseClass should be used for parents and children as a base class and should extends from CompositeComponent<TCompositeBaseClass>
     * */
    ...
    private:
        TCompositeBaseClass* m_parent { nullptr };
        std::vector<TCompositeBaseClass*> m_children;
    };
